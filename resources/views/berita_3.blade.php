                    ...
                    <div class="section" id="b-section-navbar-search-form" name="Navbar: search form">
                        <div class="widget BlogSearch" data-version="2" id="BlogSearch1">
                            <form action="" class="form-inline">
                                <input aria-label="Search this blog" class="form-control mr-sm-2" name="q" placeholder="Pencarian" type="text">
                                <button class="btn btn-success my-2 my-sm-0" type="submit">Temukan</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <hr>
                <!-- Preview Image -->
                <img class="card-img-top" src="img/gambar3.jpg" alt="Card image cap">
